...
class _MyAppState extends State<MyApp> {
  final _addressController = TextEditingController(text:"222.173.76.34");
  final _usernameController = TextEditingController(text:"admin20G");
  final _passwordController = TextEditingController(text:"Hh123456");
